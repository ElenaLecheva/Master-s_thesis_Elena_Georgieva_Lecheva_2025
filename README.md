...
This notebook uses Python 3.11.11 and the following libraries and their versions:
-	pandas 2.2.2
-	numpy 1.26.4
-	os
-	random
...
For the pre-processing of the data, I first inspect the metadata. All age and sex values are valid and there are no errors.
...
The pre-processing of the data, the model architecture, the custom generator function and the focal loss function are adapted from the following notebook by Narek HM found on Kaggle. https://www.kaggle.com/code/nhm1440/image-metadata-with-keras-imagedatagenerator

The custom defined function "print_best_val_loss_and_accuracy" has been borrowed from exrcise ML4BI_E6 from the course Machine Learning for Business Intelligence 2.
